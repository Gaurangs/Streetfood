...
/***/ "../../../../../admin/app/server-error/server-error-routing.module.ts":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__server_error_component__ = __webpack_require__("../../../../../admin/app/server-error/server-error.component.ts");
...
/***/ "../../../../../admin/app/server-error/server-error.component.html":
...
/***/ "../../../../../admin/app/server-error/server-error.component.scss":
...
/***/ "../../../../../admin/app/server-error/server-error.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ServerErrorComponent = /** @class */ (function () {
    ...
    ServerErrorComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("../../../../../admin/app/server-error/server-error.component.html"),
            styles: [__webpack_require__("../../../../../admin/app/server-error/server-error.component.scss")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__server_error_routing_module__ = __webpack_require__("../../../../../admin/app/server-error/server-error-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__server_error_component__ = __webpack_require__("../../../../../admin/app/server-error/server-error.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
