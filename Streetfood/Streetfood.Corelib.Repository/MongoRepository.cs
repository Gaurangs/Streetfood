...
using Streetfood.Corelib.Utils;
...
namespace Streetfood.Corelib.Repository
{
    public class MongoRepository<T> : IRepository<T> where T : IEntity
    {
        ...
        {
            string strCon = settings.Value.ConnectionString;
            string strDatabase = settings.Value.Database;
            ...
            MongoUrl mongoUrl = MongoUrl.Create(strCon);


            this._database = client.GetDatabase(strDatabase);
